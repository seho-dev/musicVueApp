  ...
  <transition name="slide">
    <div class="user-center">
      ...
      <div class="switches-wrapper">
        <switches :switches="clickResult" :currentIndex="currentIndex" @switch="switchHeader"></switches>
      </div>
      ...
      <div class="list-wrapper" ref="listWrapper">
        ...
        <scroll ref="playList" class="list-scroll" v-if="currentIndex===1" :data="playHistoryList">
          <div class="list-inner">
